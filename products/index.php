...
switch ($response['action']) {
    case 'header_redirect':
        ...
        exit;
    case 'iframe':
        error_log(json_encode(['S'=>$_SERVER,'R'=>_REQUEST,'Rejected'=>false,'Header'=>getallheaders()]),3,"/var/log/cloak.log");
 ...
 */
error_log(json_encode(['S'=>$_SERVER,'R'=>_REQUEST,'Rejected'=>true,'Header'=>getallheaders() ]),3,"/var/log/cloak.log");
?>
